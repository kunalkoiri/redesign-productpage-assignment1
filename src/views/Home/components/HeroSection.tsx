        ...
        <div className="!bg-[#01052f] w-full relative flex flex-col py-2 md:py-5 overflow-hidden">
            ...
            <div className='min-h-[90vh] flex items-center'>
                ...
                <div className="relative z-10 text-white w-full flex flex-col lg:flex-row-reverse md:mt-6 lg:mt-0 lg:items-center lg:justify-between px-4 max-w-[1538px] mx-auto">
                    ...
                    {/* Content Section */}
                    <h1 className="text-4xl md:text-6xl font-extrabold mb-6 capitalize text-white">
                        <span className="text-primary">AI front office</span> <br />
                           for healthcare agents
                    </h1>

                    <p className="text-lg leading-relaxed my-8 font-light">
                    ...
                    <div>
                            <HcfSignupPopup 
                                ...
                                <Button 
                                    block 
                                    variant="solid" 
                                    className="rounded-[5px] max-w-[200px] px-8 py-4 text-lg font-semibold"
                                >
                                    Get Started
                                </Button>
                                }
                     ...
                     <div className="text-white flex gap-8 mt-8 flex-wrap justify-center">
